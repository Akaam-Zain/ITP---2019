...
CREATE TABLE `order` (
  ...
  `customerAddress` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`orderID`)
...
INSERT INTO `order` VALUES (1,'2019-08-29 04:45:24','card','processing','Akaam Zain','0770161415','akaam129@gmail.com','419, Cross Street, Kandy'),(2,'2019-08-29 11:26:12','card','processing','ss','d','d','e');
